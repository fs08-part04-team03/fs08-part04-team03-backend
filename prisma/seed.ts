...
const subCategories = [
  ...
  { id: 109, name: '탄산음료', parentCategoryId: 2 },
  { id: 110, name: '과즙음료', parentCategoryId: 2 },
  { id: 111, name: '에너지음료', parentCategoryId: 2 },
  { id: 112, name: '이온음료', parentCategoryId: 2 },
  { id: 113, name: '건강음료', parentCategoryId: 2 },
  { id: 114, name: '차류', parentCategoryId: 2 },

  // 생수 (parentCategoryId: 3) - 2개
  { id: 115, name: '생수', parentCategoryId: 3 },
  { id: 116, name: '스파클링', parentCategoryId: 3 },

  // 간편식 (parentCategoryId: 4) - 5개
  { id: 117, name: '컵라면', parentCategoryId: 4 },
  { id: 118, name: '소시지', parentCategoryId: 4 },
  { id: 119, name: '계란', parentCategoryId: 4 },
  { id: 120, name: '컵밥류', parentCategoryId: 4 },
  { id: 121, name: '시리얼', parentCategoryId: 4 },

  // 신선식 (parentCategoryId: 5) - 6개
  { id: 122, name: '과일', parentCategoryId: 5 },
  { id: 123, name: '샐러드', parentCategoryId: 5 },
  { id: 124, name: '빵', parentCategoryId: 5 },
  { id: 125, name: '샌드위치', parentCategoryId: 5 },
  { id: 126, name: '요거트류', parentCategoryId: 5 },
  { id: 127, name: '유제품', parentCategoryId: 5 },

  // 원두커피 (parentCategoryId: 6) - 3개
  { id: 128, name: '드립커피', parentCategoryId: 6 },
  { id: 129, name: '원두', parentCategoryId: 6 },
  { id: 130, name: '캡슐커피', parentCategoryId: 6 },

  // 비품 (parentCategoryId: 7) - 4개
  { id: 131, name: '일회용품', parentCategoryId: 7 },
  { id: 132, name: '사무용품', parentCategoryId: 7 },
  { id: 133, name: '청소용품', parentCategoryId: 7 },
  { id: 134, name: '위생용품', parentCategoryId: 7 },
];
...
const products = [
  ...
  // 음료 - 탄산음료(109), 과즙음료(110), 에너지음료(111), 이온음료(112), 건강음료(113), 차류(114)
  {
    name: '코카콜라 500ml',
    price: 2200,
  ...
  // 간편식 - 컵라면(117), 소시지(118), 계란(119), 컵밥류(120), 시리얼(121)
  {
    name: '농심 신라면 컵',
    price: 1500,
  ...
  // 신선식 - 과일(122), 샐러드(123), 빵(124), 샌드위치(125), 요거트류(126), 유제품(127)
  {
    name: '사과 1개',
    price: 2000,
  ...
  // 비품 - 일회용품(131), 사무용품(132), 청소용품(133), 위생용품(134)
  {
    name: '일회용 종이컵 100개',
    price: 3000,
